...
const getCurrentDateTime = () => {
  ...
  if (hours >= 23) base_time = '2300';  // 23시 이상은 23시
  else if (hours >= 20) base_time = '2000';  // 20시 이상은 20시
  else if (hours >= 17) base_time = '1700';  // 17시 이상은 17시
  else if (hours >= 14) base_time = '1400';  // 14시 이상은 14시
  else if (hours >= 11) base_time = '1100';  // 11시 이상은 11시
  else if (hours >= 8) base_time = '0800';  // 8시 이상은 8시
  else if (hours >= 5) base_time = '0500';  // 5시 이상은 5시
